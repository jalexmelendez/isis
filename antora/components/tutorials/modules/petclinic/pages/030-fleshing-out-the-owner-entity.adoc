...
At the moment all of the properties of `PetOwner` are grouped into a single fieldset.
It would be an improvement to group properties according to their nature, for example the "phoneNumber" and "emailAddress" in a "Contact Details" fieldset.
